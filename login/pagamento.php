...
/* Reduz o tamanho geral do card */
.smaller-card {
  max-width: 700px; /* Define a largura máxima */
  margin: 0 auto; /* Centraliza o card na coluna */
}

/* Reduz a imagem dentro do card */
.smaller-card .card-image .image {
  max-height: 200px; /* Limita a altura da imagem */
  overflow: hidden; /* Garante que nada fora da área visível seja cortado */
}

/* Ajusta o texto para parecer menor */
.smaller-card .title {
  font-size: 1.25rem; /* Reduz o tamanho do título */
}

.smaller-card .subtitle {
  font-size: 0.875rem; /* Reduz o tamanho do subtítulo */
}

.smaller-card .content {
  font-size: 0.9rem; /* Reduz o tamanho do texto de conteúdo */
}
...
.padded-column {
    padding: 20px; /* Adiciona espaço interno ao redor de cada coluna */
  }
    ...
    <a class="navbar-item has-text-white" href="pagnaprincipal.php">
      ...
      <div class="navbar-item has-dropdown is-hoverable">
        ...
        <div class="navbar-dropdown">
          ...
          <a class="navbar-item is-selected has-text-white" href="criadores.php">
            Contato
          </a>
...
<div class="columns">
  <!-- Card -->
  <!-- Card reduzido -->
<div class="column is-half padded-column">
    ...
    <div class="card-content">
      <div class="media">
        ...
        <div class="title-info">
          <p class="title is-5">Gestão Básica</p> <!-- Tamanho reduzido -->
          <p class="subtitle is-7">20 horas</p> <!-- Tamanho reduzido -->
        </div>
      </div>
      <div class="content">
        <p style="font-size: 0.9rem;">Este curso é ideal para quem está começando a entender os fundamentos da gestão financeira e deseja desenvolver habilidades essenciais para administrar recursos de forma eficiente.<br><br> Ao longo das aulas, o aluno será introduzido a conceitos fundamentais que formam a base da organização financeira, com ênfase no planejamento e controle de orçamentos.<br><br>

Serão abordados tópicos como a elaboração e gestão de um orçamento, que permite uma visão clara sobre as receitas e despesas, facilitando a tomada de decisões financeiras mais assertivas. <br><br>Também será explorado o controle de despesas, essencial para garantir que os gastos não ultrapassem os limites do planejado, evitando surpresas e dificuldades financeiras.<br><br>

O curso incluirá ainda o estudo do fluxo de caixa, uma ferramenta indispensável para monitorar a entrada e saída de recursos financeiros de uma empresa ou mesmo de finanças pessoais.<br><br> Compreender o fluxo de caixa permite uma gestão mais eficiente, garantindo que sempre haja recursos disponíveis para cobrir as obrigações financeiras no curto e longo prazo.<br><br>

Ao final, o aluno estará apto a aplicar essas práticas no seu dia a dia, seja na administração de uma pequena empresa, seja na gestão de suas finanças pessoais, criando um planejamento mais organizado, controlado e eficaz.</p>
        <br />
        <p style="font-size: 0.9rem;"><strong>Conclusão de no máximo 15 dias</strong></p>
      </div>
